...
function PeopleSays() {
    ...
    return (
        <>
            <h1 className="text-[2rem] md:text-[2.5rem] font-bold text-center mt-8 text-blue-600 font-sans">Our Community</h1>
            <div className="slider-container mt-12 mb-[20rem] md:mb-[10rem] overflow-hidden" style={{backgroundColor: "#141d30"}}>
